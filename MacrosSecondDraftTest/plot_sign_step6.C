...
void plot_sign_step6(){
  ...
  */
  ...
  //TH1F* draw(TH1F *hbkg[0],TH1F *hbkg[1],TH1F *hbkg[2],TH1F *hbkg[3],TH1F *hsignal[0],TH1F *hsignal[1],TH1F *hsignal[2],TH1F *hsignal[3],TGraph *signif0,TGraph *signif1,TGraph *signif2,TGraph *signif3) {          
