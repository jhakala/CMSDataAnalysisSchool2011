...
// Wed Dec 29 01:59:07 2010 by ROOT version 5.25/02
// from TTree t/t
// found on file: ../ZJets/zjets_exo_v2_387.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ZJets/zjets_exo_v2_387.root");
      if (!f) {
         f = new TFile("../ZJets/zjets_exo_v2_387.root");
         f->cd("../ZJets/zjets_exo_v2_387.root:/BHAnalyzer");
      }
