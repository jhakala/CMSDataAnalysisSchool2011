/////////////////////////////////////////////////////////
//
// File: 	shape_background_systematics.C 
...
void shape_background_systematics(){
  ...
  //Systematics due to shape variation is defined as the difference between two outliers.
  Float_t max[70]; 
  Float_t min[70]; 
  ...
  shape_unc -> GetXaxis() -> SetTitle("ST");
  shape_unc -> Write();
  ff->Close(); 
